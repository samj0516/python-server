...
def get_all_animals():
    ...
    with sqlite3.connect("./kennel.db") as conn:
        ...
        # Add the dictionary representation of the location to the animal
          ...
          customer = Customer(row['customer_id'], row['customer_name'], row['customer_address'], row['customer_email'], None)
...
def get_single_animal(id):
    with sqlite3.connect("./kennel.db") as conn:
        ...
        # Add the dictionary representation of the location to the animal
        animal.location = location.__dict__
        customer = Customer(data['customer_id'], data['customer_name'], data['customer_address'], data['customer_email'], None)
        animal.customer = customer.__dict__
